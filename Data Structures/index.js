...
function storeData(){
    let yourArray = [ "John", "Doe", 29, false, 455.98];
}
...
// numbers.splice(startIndex, amountToDelete, newValueStartIndex, newValueAmount);
...
let myNestedArray = [
  // Only change code below this line
  ['unshift', false, 1, 2, 3, 'complex', 'nested'], //lvl1
